...
from network.fs_net_repo.PoseR import Rot_red, Rot_green, Rot_green_nonLinear, Rot_red_nonLinear, Rot_green_atten, Rot_red_atten
from network.fs_net_repo.PoseTs import Pose_Ts, Pose_Ts_nonLinear, Pose_Ts_atten
